...
SRCS	=	ft_printf.c ft_parse.c ft_check_parse.c

FT_SRCS	=	./Libft/ft_atoi.c ./Libft/ft_bzero.c ./Libft/ft_calloc.c ./Libft/ft_isalnum.c ./Libft/ft_isalpha.c\
			...
			./Libft/ft_toupper.c\
			./ft_printf.c ft_parse.c ./ft_check_parse.c ./main.c\
